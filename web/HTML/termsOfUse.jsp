...
<body>
    ...
    <section class="content">
        ...
        <h2>Welcome to Kluczex.com.pl!</h2>

        <h4>These terms and conditions outline the rules and regulations for the use of Kluczex Website, located at
            Kluczex.com.pl.</h4>
        <h4>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            Kluczex.com.pl if you do not agree to take all of the terms and conditions stated on this page.</h4>
        <h4>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
            ...
            of the Company's stated services, in accordance with and subject to, prevailing law of Poland. Any use of
            the above terminology or other words in the singular, plural, capitalization and/or he/she or they, are
            taken as interchangeable and therefore as referring to same. </h4>
        <h4>
        ...
        <h4> We employ the use of cookies. By accessing Kluczex.com.pl, you agreed to use cookies in agreement with the
            Kluczex Privacy Policy.</h4>

        <h4> Most interactive websites use cookies to let us retrieve the user's details for each visit. Cookies are
            used by
            our website to enable the functionality of certain areas to make it easier for people visiting our website.
            Some
            of our affiliate/advertising partners may also use cookies.</h4>


        <h2>License</h2>

        <h4> Unless otherwise stated, Company Name and/or its licensors own the intellectual property rights for all
            material
            on Kluczex.com.pl. All intellectual property rights are reserved. You may access this from Kluczex.com.pl
            for
            your own personal use subjected to restrictions set in these terms and conditions.</h4>


        <h2>
            You must not:</h2>

        <h4> Republish material from Kluczex.com.pl
            Sell, rent or sub-license material from Kluczex.com.pl
            Reproduce, duplicate or copy material from Kluczex.com.pl
            Redistribute content from Kluczex.com.pl
            This Agreement shall begin on the date hereof.</h4>
        <h4> Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain
            areas of the website. Company Name does not filter, edit, publish or review Comments prior to their presence
            on
            the website. Comments do not reflect the views and opinions of Company Name,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted
            by applicable laws, Company Name shall not be liable for the Comments or for any liability, damages or
            expenses
        ...
        <h2>
            You warrant and represent that:</h2>

        <h4> You are entitled to post the Comments on our website and have all necessary licenses and consents to do so;
            ...
            reproduce and edit any of your Comments in any and all forms, formats or media.</h4>
        <h2> Hyperlinking to our Content
            The following organizations may link to our Website without prior written approval:</h4>
        ...
        <h4> commonly-known consumer and/or business information sources;
            ...
            Company
            Name; and (d) the link is in the context of general resource information.
        </h4>
        <h4>
            ...
            (c)
            fits within the context of the linking party's site.</h4>
        ...
        <h2>
            Approved organizations may hyperlink to our Website as follows:</h2>

        <h4> By use of our corporate name; or
            ...
            No use of Kluczex logo or other artwork will be allowed for linking absent a trademark license agreement.
        </h4>
        <h4>
            iFrames
            Without prior approval and written permission, you may not create frames around our Webpages that alter in
            any
            way the visual presentation or appearance of our Website.</h4>
        <h4>
            Content Liability
            ...
            infringement or other violation of, any third party rights.</h4>
        <h4>
            ...
            bound to
            and follow these linking terms and conditions.</h4>
        <h4></h4>


        <h4> Removal of links from our website
        ...
        <h4>
            ...
            relating to our website and the use of this website. Nothing in this disclaimer will:</h4>
        <h4>
            ...
            liabilities arising in contract, in tort and for breach of statutory duty.</h4>
        <h4>

            As long as the website and the information and services on the website are provided free of charge, we will
            not
            be liable for any loss or damage of any nature.</h4>
